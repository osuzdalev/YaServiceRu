...
def insert_new_order(user_id: int, device_context: dict, default_contractor_id: int = int(CONSTANTS.get("TELEGRAM_ID", "FR"))) -> None:
...
def get_customer_last_OrderID(user_id: int, default_contractor_id: int = int(CONSTANTS.get("TELEGRAM_ID", "FR"))) -> int:
