...
from src.command.client.semantic_filters.weaviate_client import WeaviateClient
...
english_filters_file = "data_reader/semantic_filters/filters/english.txt"
russian_filters_file = "data_reader/semantic_filters/filters/russian.txt"
