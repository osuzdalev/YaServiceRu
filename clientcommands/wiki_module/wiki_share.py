...
async def share(update: Update, _: ContextTypes.DEFAULT_TYPE) -> Union[int, None]:
    ...
    elif query_text == WIKI_DATA_DICT["Windows"]["Mac"]["Update_Driver"]["Driver_Installation_Update"]["0_EN"]:
        results = [
            InlineQueryResultArticle(
                id=str(uuid4()),
                title=WIKI_DATA_DICT["Windows"]["Mac"]["Update_Driver"]["Driver_Installation_Update"]["0_EN"],
                input_message_content=InputTextMessageContent(
                    get_answer_path(
                        WIKI_DATA_DICT["Windows"]["Mac"]["Update_Driver"]["Driver_Installation_Update"]["0_EN"])
                    + WIKI_DATA_DICT["Windows"]["Mac"]["Update_Driver"]["Driver_Installation_Update"]["Text"],
                    parse_mode=ParseMode.MARKDOWN)
            )
        ]
    # --------------------------------------------- UPDATE_WINDOWS_10_11 -----------------------------------------------
    elif query_text == WIKI_DATA_DICT["Windows"]["Mac"]["Update_Driver"]["Update_Windows_10_11"]["0_EN"]:
        results = [
            InlineQueryResultArticle(
                id=str(uuid4()),
                title=WIKI_DATA_DICT["Windows"]["Mac"]["Update_Driver"]["Update_Windows_10_11"]["0_EN"],
                input_message_content=InputTextMessageContent(
                    get_answer_path(
                        WIKI_DATA_DICT["Windows"]["Mac"]["Update_Driver"]["Update_Windows_10_11"]["0_EN"])
                    + WIKI_DATA_DICT["Windows"]["Mac"]["Update_Driver"]["Update_Windows_10_11"]["Text"],
                    parse_mode=ParseMode.MARKDOWN)
            )
        ]
    # --------------------------------------------- TURN_OFF_AUTOMATIC_UPDATES -----------------------------------------
    elif query_text == WIKI_DATA_DICT["Windows"]["Mac"]["Update_Driver"]["Turn_Off_Automatic_Updates"]["0_EN"]:
        results = [
            InlineQueryResultArticle(
                id=str(uuid4()),
                title=WIKI_DATA_DICT["Windows"]["Mac"]["Update_Driver"]["Turn_Off_Automatic_Updates"]["0_EN"],
                input_message_content=InputTextMessageContent(
                    get_answer_path(
                        WIKI_DATA_DICT["Windows"]["Mac"]["Update_Driver"]["Turn_Off_Automatic_Updates"]["0_EN"])
                    + WIKI_DATA_DICT["Windows"]["Mac"]["Update_Driver"]["Turn_Off_Automatic_Updates"]["Text"],
                    parse_mode=ParseMode.MARKDOWN)
            )
        ]
