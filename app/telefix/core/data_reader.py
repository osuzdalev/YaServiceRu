...
class ChatGPTDataReader(DataReader):
    def __init__(self, config: str, file_path: str = "telefix/data/user/chatbot/data.yaml"):
...
class StartReader(DataReader):
    def __init__(self, config: str, file_path: str = "telefix/data/user/start/data.yaml"):
        super().__init__(config, file_path)
...
class VectorDatabaseReader(DataReader):
    def __init__(
        self, config: str = None, file_path: str = "telefix/data/vector_database/data.yaml"
    ):
        super().__init__(config, file_path)
